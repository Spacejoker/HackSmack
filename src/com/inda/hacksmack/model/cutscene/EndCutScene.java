...
public class EndCutScene implements CutScene, InputEvent{
	...
	public EndCutScene() {
		...
		text1 = ImageEntityFactory.newImageEntity(new String[] { "endscreen" }, new Vector2f(HackSmackConstants.SCREEN_WIDTH, HackSmackConstants.SCREEN_HEIGHT - 340), 1);
