...
public class IntroSplashCutScene implements CutScene, InputEvent{
	...
	public IntroSplashCutScene(GameState state) {
		super();
		this.state = state;
		InputHandler.getInstance().addEvent(this);
		
		
		text1 = ImageEntityFactory.newImageEntity(new String[] { "splashscreen" }, new Vector2f(HackSmackConstants.SCREEN_WIDTH, HackSmackConstants.SCREEN_HEIGHT - 340), 1);
